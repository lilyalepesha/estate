<section class="login">
    <div class="login__container container">
        ...
        <form class="login__form form" action="{{ route('architect.login.store') }}" method="POST">
            @csrf
            <div class="login__form-wrapper form__wrapper">
                <div class="login__form-input-wrapper form__input-wrapper">
                    ...
                    <input name="email" value="{{ old('email') }}" class="login__form-input form__input" type="text" required placeholder="Email">
                ...
                <div class="login__form-input-wrapper form__input-wrapper">
                    ...
                    <input name="password" value="{{ old('password') }}"  class="login__form-input form__input" type="password" required placeholder="Пароль">
            ...
            <button class="login__form-button blue-button" type="submit">Войти</button>
        </form>
        @guest
